      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div> Dibuat dan Dikembangkan oleh <a href="#">Fauza</a>
        </div>
  ...
  <script type="text/javascript">
        jQuery(document).on('submit', '#upload-form', function(e){
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "<?= base_url("Admin/Galeri/upload_gambar/"); ?>",
    ...
    <script type="text/javascript">
        jQuery(document).on('submit', '#upload-form-klien', function(e){
            jQuery("#chk-error").html('');
            e.preventDefault();
            $.ajax({
                xhr: function() {
                ...
                type: 'POST',
                url: "<?= base_url("Admin/Klien/upload_gambar/"); ?>",
                data: new FormData(this),
                contentType: false,
                cache: false,
                processData:false,
                ...
                success: function(json){
                    if(json == 'success'){
                        $('#upload-form-klien')[0].reset();
                        $('#uploaded_file_klien').html('<p style="color:#28A74B;">File has uploaded successfully!</p>');
                    }else if(json == 'failed'){
                        $('#uploaded_file_klien').html('<p style="color:#EA4335;">Please select a valid file to upload.</p>');
                    }
                    setTimeout('auto_reload()',1000)
