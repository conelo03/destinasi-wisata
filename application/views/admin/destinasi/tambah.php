  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Tambah Kelola Destinasi</div>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('tambah-destinasi'); ?>" method="post" enctype="multipart/form-data">
              <div class="card-header">
                <h4>Form Tambah Destinasi</h4>
              </div>
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <textarea type="text" name="konten" class="form-control ckeditor" id="ckeditor"><?= set_value('konten'); ?></textarea>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="url_google_maps" class="form-control" value="<?= set_value('url_google_maps'); ?>" required="">
                  <?= form_error('url_google_maps', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label>Foto / Gambar</label>
                  <input type="file" name="gambar[]" class="form-control" value="<?= set_value('gambar'); ?>" required="" multiple>
                  <?= form_error('gambar', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label class="d-block">Status</label>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="status" value="publish" id="exampleRadios3" <?= set_value('status') == 'publish' ? 'checked' : '' ; ?> >
                    <label class="form-check-label" for="exampleRadios3">
                      Publish
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="status" value="draft" id="exampleRadios4" <?= set_value('status') == 'draft' ? 'checked' : '' ; ?> >
